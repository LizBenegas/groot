      ...
      var Groot = (function() {
          ...
          Groot.prototype = {
              setup: function() {
                  ...
                  // verano/primavera leaf image
                  pushStyle();
                      background(0, 0);
                      //main
                      noStroke();
                      fill(this.themes.verano.colors.outline);
                      beginShape();
                          vertex(195, 211);
                      ...
                      endShape(CLOSE);
                      //inner full
                      fill(this.themes.verano.colors.medium);
                      beginShape();
                          vertex(194, 204);
                      ...
                      endShape(CLOSE);
                      //inner half
                      fill(this.themes.verano.colors.dark);
                      beginShape();
                          vertex(194, 204);
                          bezierVertex(216, 181, 210, 161, 193, 144);
                      ...
                      //line on leaf
                      noFill();
                      stroke(this.themes.verano.colors.outline);
                      strokeWeight(1);
                  ...
                  this.themes.verano.images.leafRight = this.images.leafRight;
                  this.themes.verano.images.leafLeft = this.images.leafLeft;
                  this.themes.fall.images.leafRight = this.images.leafRightAutumn;
                  this.themes.fall.images.leafLeft = this.images.leafLeftAutumn;
                  this.themes.invierno.images.leafRight = this.images.leafRightAutumn;
                  this.themes.invierno.images.leafLeft = this.images.leafLeftAutumn;
                  this.themes.primavera.images.leafRight = this.images.leafRight;
                  this.themes.primavera.images.leafLeft = this.images.leafLeft;
  
                  //blossoms for primavera
                  background(0, 0);
                  pushMatrix();
                      translate(300, 300);
      ...
      var Scene = (function() {
              ...
              this.buttons = {
                  ...
                  themes: {
                      verano: new Button({
                          ...
                          selected: true,
                          func: function() {
                              scene.theme = scene.themes.verano;
                              scene.groot.theme = scene.groot.themes.verano;
                              scene.updateThemeButtons("verano");
                          }
                      }),
                      fall: new Button({
                          content: "Fall",
                      ...
                      invierno: new Button({
                          ...
                          y: 100,
                          func: function() {
                              scene.theme = scene.themes.invierno;
                              scene.groot.theme = scene.groot.themes.invierno;
                              scene.updateThemeButtons("invierno");
                          }
                      }),
                      primavera: new Button({
                          ...
                          y: 140,
                          func: function() {
                              scene.theme = scene.themes.primavera;
                              scene.groot.theme = scene.groot.themes.primavera;
                              scene.updateThemeButtons("primavera");
                          }
                      })
                  },
                  characters: {
          ...
          Scene.prototype = {
              ...
              draw: function() {
                  ...
                  if(this.theme === this.themes.invierno) {
                      if(frameCount % 20 === 0) {
                  ...
                  else { //fade snow out an remove if not invierno
                  ...
                  if(this.theme === this.themes.verano) {
                  ...
                  //also show falling autumn leaves similar to falling snow in invierno
                  ...
                  else if(this.theme === this.themes.invierno) {
                      for(var i = 0; i < this.groot.coords.leaves.length; i++) {
                  ...
                  //show smaller leaves and primavera flowers
                  else if(this.theme === this.themes.primavera) {
                      for(var i = 0; i < this.groot.coords.leaves.length; i++) {
              ...
              go: function(fr) {
                  ...
                  if(!this.started) {
                      pushStyle();
                          ...
                          textSize(22);
                          fill(20, 150);
                          text("Check the comments for some\ntips like clicking directly on Groot.", 300, 40);
                      popStyle();
                  }
